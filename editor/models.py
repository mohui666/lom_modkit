...
NODE_SCHEMAS: dict[str, dict] = {
    ...
    "combat": {
        ...
        "fields": [
            ...
            ("player_max_health", "赵活最大血量", "int", True),
            ("player_health", "赵活初始血量", "int", True),
            ("player_max_stamina", "赵活最大气力", "int", True),
            ("player_stamina", "赵活初始气力", "int", True),
            ("player_stamina_power", "赵活内力（雷达）", "int", True),
            ("player_strength", "赵活体力", "int", True),
            ("player_internal", "赵活阴阳内功", "int", True),
            ("player_dexterity", "赵活轻功", "int", True),
            ("player_talking", "赵活嘴力", "int", True),
            ("player_defence", "赵活防御", "int", True),
            ("player_sword", "赵活刀剑", "int", True),
            ("player_fist", "赵活拳掌", "int", True),
            ("player_martial_weapon", "赵活暗器", "int", True),
            ("player_mental", "赵活心相", "int", True),
            ("player_poison_resist", "赵活抗毒", "int", True),
            ("player_paralyzed_resist", "赵活抗麻", "int", True),
            ("player_disposition", "赵活性情", "int", True),
            ("player_behaviour", "赵活处世", "int", True),
            ("player_karma", "赵活道德", "int", True),
            ("player_training", "赵活修养", "int", True),
            ("player_talents", "赵活决斗技能", "combat_talents", True),
