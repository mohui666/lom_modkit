    ...
    internal static class I18n
    {
        ...
        private static Dictionary<string, string> MakeChs()
        {
            return new Dictionary<string, string>
            {
                ...
                { "campaign.none", "未加载兼容战役：Runtime 1.0.1 只接受 package_format=3、story_schema=2 且带稳定 campaign_id 的 MOD。" },
        ...
        private static Dictionary<string, string> MakeCht()
        {
            return new Dictionary<string, string>
            {
                ...
                { "campaign.none", "未載入相容戰役：Runtime 1.0.1 僅接受 package_format=3、story_schema=2 且帶穩定 campaign_id 的 MOD。" },
        ...
        private static Dictionary<string, string> MakeJa()
        {
            return new Dictionary<string, string>
            {
                ...
                { "campaign.none", "互換キャンペーンがありません。Runtime 1.0.1 は package_format=3、story_schema=2、安定した campaign_id が必要です。" },
        ...
        private static Dictionary<string, string> MakeKo()
        {
            return new Dictionary<string, string>
            {
                ...
                { "campaign.none", "호환 전역이 없습니다. Runtime 1.0.1은 package_format=3, story_schema=2, 안정적인 campaign_id가 필요합니다." },
